...
namespace MY_MVC_APPLICATION.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LoginController : MY_MVC_APPLICATION.Controllers.LoginController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.User user);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(Models.User user)
        {
