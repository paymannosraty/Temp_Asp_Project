...
namespace MY_MVC_APPLICATION.Controllers
{
    public partial class TrafficsController
    {
        ...
        protected TrafficsController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TrafficsController Actions { get { return MVC.Traffics; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Traffics";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Traffics";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        {
            public readonly string traffic = "traffic";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Traffics/Create.cshtml";
            public readonly string Delete = "~/Views/Traffics/Delete.cshtml";
            public readonly string Details = "~/Views/Traffics/Details.cshtml";
            public readonly string Edit = "~/Views/Traffics/Edit.cshtml";
            public readonly string Index = "~/Views/Traffics/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TrafficsController : MY_MVC_APPLICATION.Controllers.TrafficsController
    {
        public T4MVC_TrafficsController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.Traffic traffic);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Models.Traffic traffic)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "traffic", traffic);
            CreateOverride(callInfo, traffic);
            return callInfo;
        }
